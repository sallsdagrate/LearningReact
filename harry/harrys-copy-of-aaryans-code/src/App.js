...
import { getProducts, getProductsFromFakeAPI, getProductsAsync, getProductsFromAPI } from "./getProducts"
/**@jsx jsx */
const App = () => {
  ...
  useEffect(()=>{
    ...
    getProductsFromAPI().then(p=>setProducts(p)).catch(err=>console.log(err))
